...
int main()
{
    ...
    spline.parameters_from_tangents(vec3f(0.0f, 0.0f, 0.0f), vec3f(1.0f, 2.0f, 0.0f), vec3f(5.0f, 0.0f, -3.0f), vec3f(0.0f, 0.0f, -4.0f));
    Plane base = Plane(vec3f(0.0f, 1.0f, 0.0f), vec3f(1.0f, 0.0f, 1.0f));
