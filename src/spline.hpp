...
public:
	...
	Spline(const gl::GLapi*, const glm::vec3, const glm::vec3, const glm::vec3, const glm::vec3);
...
private:
	...
	bool calculate_near_far(const glm::vec3, const glm::vec3, const glm::vec3, const glm::vec3, vec2f*);
};
