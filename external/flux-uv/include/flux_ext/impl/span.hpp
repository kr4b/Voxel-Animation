...
// **flux-MODIFIED**: define all macros before use
//   GCC doesn't respect #pragma diagnostic ... on -Wundef, but we use -Wundef
//   for the rest of flux. This produces rather large amounts of warnings in
//   this header.
// **flux-MODIFIED**: use FLUX_STDFEAT to work around some quirks (e.g., Clang
//   in C++17 mode doesn't seem to have access to the C++17 standard library).
...
#include <flux/compat/byte.hpp> // **flux-MODIFIED**
...
#if !defined(span_CPP11_OR_GREATER)
#	define span_CPP11_OR_GREATER 0
#endif
...
#if !defined(span_CPP14_OR_GREATER)
#	define span_CPP14_OR_GREATER 0
#endif
...
#if !defined(span_CPP17_OR_GREATER)
#	define span_CPP17_OR_GREATER 0
#endif
...
// **flux-MODIFIED**: use flux::compat::byte 
// (which is std::byte when such exists)
...
// C++ feature usage:
#if !defined(span_HAVE_ADDRESSOF)
#	define span_HAVE_ADDRESSOF 0
#endif
...
#if !defined(span_HAVE_CONSTEXPR_11)
#	define span_HAVE_CONSTEXPR_11 0
#endif
...
#if !defined(span_HAVE_CONSTEXPR_14)
#	define span_HAVE_CONSTEXPR_14 0
#endif
...
#if !defined(span_HAVE_EXPLICIT_CONVERSION)
#	define span_HAVE_EXPLICIT_CONVERSION 0
#endif
...
#if !defined(span_HAVE_INLINE_NAMESPACE)
#	define span_HAVE_INLINE_NAMESPACE 0
#endif
...
#if !defined(span_HAVE_IS_DELETE)
#	define span_HAVE_IS_DELETE 0
#endif
...
#if !defined(span_HAVE_IS_NOEXCEPT)
#	define span_HAVE_IS_NOEXCEPT 0
#endif
...
#if !defined(span_HAVE_NULLPTR)
#	define span_HAVE_NULLPTR 0
#endif
...
#if !defined(span_HAVE_NODISCARD)
#	define span_HAVE_NODISCARD 0
#endif
...
#if !defined(span_HAVE_NORETURN)
#	define span_HAVE_NORETURN 0
#endif
...
#if !defined(span_HAVE_DEFAULT_FUNCTION_TEMPLATE_ARG)
#	define span_HAVE_DEFAULT_FUNCTION_TEMPLATE_ARG 0
#endif
#if !defined(span_HAVE_CONTAINER_DATA_METHOD)
#	define span_HAVE_CONTAINER_DATA_METHOD 0
#endif
...
// Additional includes:
#if !defined(span_HAVE_TYPE_TRAITS)
#	define span_HAVE_TYPE_TRAITS 0
#endif
...
#if !defined(span_HAVE_ARRAY)
#	define span_HAVE_ARRAY 0
#endif
...
#if !defined(span_HAVE_BYTE)
#	define span_HAVE_BYTE 0
#endif
...
#if !defined(span_HAVE_CONSTRAINED_SPAN_CONTAINER_CTOR)
#	define span_HAVE_CONSTRAINED_SPAN_CONTAINER_CTOR 0
#endif
...
#if !defined(span_CONFIG_CONTRACT_VIOLATION_THROWS_V)
...
#if !defined(span_HAVE_REMOVE_CONST)
#	define span_HAVE_REMOVE_CONST 0
#endif
...
#if !defined(span_HAVE_DEDUCTION_GUIDES)
#	define span_HAVE_DEDUCTION_GUIDES 0
#endif
...
// **flux-MODIFIED**: use flux::compat::byte 
// this aliases to std::byte when it is available.

#if span_HAVE( BYTE )
template< class T, index_t Extent >
inline span< const flux::compat::byte, ( (Extent == dynamic_extent) ? dynamic_extent : (index_t(sizeof(T)) * Extent) ) >
as_bytes( span<T,Extent> spn ) span_noexcept
{
#if 0
    return { reinterpret_cast< flux::compat::byte const * >( spn.data(), spn.size_bytes() ) };
#else
    return span< const flux::compat::byte, ( (Extent == dynamic_extent) ? dynamic_extent : (index_t(sizeof(T)) * Extent) ) >(
        reinterpret_cast< flux::compat::byte const * >( spn.data() ), spn.size_bytes() );  // NOLINT
#endif
}

template< class T, index_t Extent >
inline span< flux::compat::byte, ( (Extent == dynamic_extent) ? dynamic_extent : (index_t(sizeof(T)) * Extent) ) >
as_writeable_bytes( span<T,Extent> spn ) span_noexcept
{
#if 0
    return { reinterpret_cast< flux::compat::byte * >( spn.data(), spn.size_bytes() ) };
#else
    return span< flux::compat::byte, ( (Extent == dynamic_extent) ? dynamic_extent : (index_t(sizeof(T)) * Extent) ) >(
        reinterpret_cast< flux::compat::byte * >( spn.data() ), spn.size_bytes() );  // NOLINT
#endif
}
...
#if !defined(span_CONFIG_PROVIDE_MAKE_SPAN)
#	define span_CONFIG_PROVIDE_MAKE_SPAN 0
#endif
