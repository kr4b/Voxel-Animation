...
// **flux-MODIFIED**: also expose invoke_result.
...
#define invoke_CPP11_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX11)//( __cplusplus >= 201103L )
#define invoke_CPP14_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX14)//( __cplusplus >= 201402L )
#define invoke_CPP17_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX17)//( __cplusplus >= 201703L )
