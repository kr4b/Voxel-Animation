...
#	define nssv_CONFIG_SELECT_STD_STRING_VIEW 0
#endif
#if !defined(nssv_CONFIG_SELECT_NONSTD_STRING_VIEW)
#	define nssv_CONFIG_SELECT_NONSTD_STRING_VIEW 0
#endif
...
// **flux-MODIFIED**
#define nssv_CPP11             (FLUX_LANGLEVEL == FLUX_LANGLEVEL_CXX11)//(__cplusplus == 201103L )
#define nssv_CPP11_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX11)//(__cplusplus >= 201103L || nssv_MSVC_LANG >= 201103L )
#define nssv_CPP14_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX14)//(__cplusplus >= 201402L || nssv_MSVC_LANG >= 201703L )
#define nssv_CPP17_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX17)//(__cplusplus >= 201703L || nssv_MSVC_LANG >= 201703L )
#define nssv_CPP20_OR_GREATER  (FLUX_LANGLEVEL >= FLUX_LANGLEVEL_CXX20)//(__cplusplus >= 202000L || nssv_MSVC_LANG >= 202000L )
...
// C++ feature usage:
#if !defined(nssv_HAVE_CONSTEXPR_11)
#	define nssv_HAVE_CONSTEXPR_11 0
#endif
...
#if !defined(nssv_HAVE_CONSTEXPR_14)
#	define nssv_HAVE_CONSTEXPR_14 0
#endif
...
#if !defined(nssv_HAVE_EXPLICIT_CONVERSION)
#	define nssv_HAVE_EXPLICIT_CONVERSION 0
#endif
...
#if !defined(nssv_HAVE_INLINE_NAMESPACE)
#	define nssv_HAVE_INLINE_NAMESPACE 0
#endif
...
#if !defined(nssv_HAVE_NOEXCEPT)
#	define nssv_HAVE_NOEXCEPT 0
#endif
...
#if !defined(nssv_HAVE_REF_QUALIFIER)
#	define nssv_HAVE_REF_QUALIFIER 0
#endif
...
#if !defined(nssv_HAVE_NULLPTR)
#	define nssv_HAVE_NULLPTR 0
#endif
...
#if !defined(nssv_HAVE_NODISCARD)
#	define nssv_HAVE_NODISCARD 0
#endif
...
public:
    ...
    {
#		if FLUX_STDQUIRK_CXX11_NONCONSTEXPR_ASSERT
		return data_[pos];
#		else // !STDQUIRK_CXX11_NONCONSTEXPR_ASSERT
        return assert( pos < size() ),
            data_[pos];
#		endif // ~ STDQUIRK_CXX11_NONCONSTEXPR_ASSERT
    }
    ...
    nssv_constexpr14 const_reference front() const { return assert( !empty() ), data_[0]; }
    nssv_constexpr14 const_reference back()  const { return assert( !empty() ), data_[size() - 1]; }
